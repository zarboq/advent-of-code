...
fn game_points() -> HashMap<String, u16> {
    ...
    score_map.insert("A X".to_owned(), 3);
    score_map.insert("A Y".to_owned(), 4);
    score_map.insert("A Z".to_owned(), 8);
    score_map.insert("B X".to_owned(), 1);
    score_map.insert("B Y".to_owned(), 5);
    score_map.insert("B Z".to_owned(), 9);
    score_map.insert("C X".to_owned(), 2);
    score_map.insert("C Y".to_owned(), 6);
    score_map.insert("C Z".to_owned(), 7);
    return score_map;
}