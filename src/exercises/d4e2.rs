...
fn full_overlap(assignements: String) -> bool {
    ...
    if (assignement1_first_section <= assignement2_last_section && assignement1_first_section >= assignement2_first_section)
    || (assignement1_last_section >= assignement2_first_section && assignement1_last_section <= assignement2_last_section)
    || (assignement2_first_section <= assignement1_last_section && assignement2_first_section >= assignement1_first_section)
    || (assignement2_last_section >= assignement1_first_section && assignement2_last_section <= assignement1_last_section){
        return true;
    }
    return false;
}